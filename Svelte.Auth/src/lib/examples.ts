...
export const azureB2CAuthSettings: AuthSettings = {
	authority:
		'https://yourtenantname.b2clogin.com/yourtenantname.onmicrosoft.com/B2C_1_signupsignin',
 ...
 */
export function createMultiTenantSettings(tenantId: string, baseAuthority: string): AuthSettings {
	return {
