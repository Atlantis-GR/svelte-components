 ...
 * Loading state store
 */
export const configLoading = derived(
  configState,
  ($state) => $state.loading
);
 ...
 * Error state store
 */
export const configError = derived(
  configState,
  ($state) => $state.error
);
 ...
 */
export const configInitialized = derived(
  configState,
 ...
 */
export const configLastUpdated = derived(
  configState,
 ...
 */
export const isProduction = derived(
  config,
 ...
 */
export const culture = derived(
  config,
  ($config) => $config?.culture || 'en-US'
);
 ...
 */
export const environmentConfig = derived(
  [config, isProduction],
  ([$config, $isProduction]) => {
