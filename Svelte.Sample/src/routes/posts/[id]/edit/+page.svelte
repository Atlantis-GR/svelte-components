...
<div class="mx-auto max-w-4xl">
	...
	{:else if error && !post}
		<div class="rounded-md border border-red-200 bg-red-50 p-4">
			...
			<div class="mt-4">
				<a href="/posts" class="text-sm font-medium text-red-600 hover:text-red-800">
					← Back to Posts
				</a>
			</div>
		</div>
			...
			<form onsubmit={handleSubmit} class="space-y-6 p-6">
						...
						<div class="flex">
							...
							<div class="ml-3">
								...
								<p class="mt-1 text-sm text-green-700">
									Your post has been updated successfully. Redirecting to view post...
								</p>
							</div>
						</div>
					</div>
						...
						<div class="flex">
							...
							<div class="ml-3">
								...
								<p class="mt-1 text-sm text-yellow-700">
									You need to be logged in to edit posts. Please authenticate first.
								</p>
							</div>
						</div>
					</div>
				...
				<div class="flex justify-end space-x-3 border-t border-gray-200 pt-4">
					...
					>
						{#if saving}
							<svg
								class="mr-3 -ml-1 inline h-4 w-4 animate-spin text-white"
								fill="none"
								viewBox="0 0 24 24"
							>
								<circle
