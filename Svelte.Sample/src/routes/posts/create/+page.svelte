<script lang="ts">
  ...
  const categories = [
    'general', 'technology', 'business', 'lifestyle', 'health', 
    'education', 'entertainment', 'sports', 'travel', 'food'
  ];
        ...
        <form class="p-6 space-y-6">
            ...
            <div class="bg-green-50 border border-green-200 rounded-md p-4">
              <div class="flex">
                ...
                <div class="ml-3">
                  ...
                  <p class="mt-1 text-sm text-green-700">Your post has been created successfully. Redirecting to posts list...</p>
                </div>
              </div>
            </div>
          {/if}
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4">
              <div class="flex">
                ...
                <div class="ml-3">
                  ...
                  <p class="mt-1 text-sm text-yellow-700">You need to be logged in to create posts. Please authenticate first.</p>
                </div>
              </div>
            </div>
          {/if}
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 text-lg border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500"
              required
            />
          </div>
          ...
          <div>
            ...
            {#if !showPreview}
              <!-- Markdown Toolbar -->
              <div class="flex items-center space-x-1 p-2 bg-gray-50 border border-gray-300 rounded-t-md">
                <button type="button" onclick={() => insertMarkdown('bold', 'bold text')} class="p-1 hover:bg-gray-200 rounded" title="Bold">
                  <strong>B</strong>
                </button>
                <button type="button" onclick={() => insertMarkdown('italic', 'italic text')} class="p-1 hover:bg-gray-200 rounded" title="Italic">
                  <em>I</em>
                </button>
                <button type="button" onclick={() => insertMarkdown('heading', 'Heading')} class="p-1 hover:bg-gray-200 rounded" title="Heading">
                  H
                </button>
                <span class="w-px h-4 bg-gray-300"></span>
                <button type="button" onclick={() => insertMarkdown('link', 'link text')} class="p-1 hover:bg-gray-200 rounded" title="Link">
                  🔗
                </button>
                <button type="button" onclick={() => insertMarkdown('image', 'alt text')} class="p-1 hover:bg-gray-200 rounded" title="Image">
                  🖼️
                </button>
                <span class="w-px h-4 bg-gray-300"></span>
                <button type="button" onclick={() => insertMarkdown('code', 'code')} class="p-1 hover:bg-gray-200 rounded" title="Code">
                  &lt;/&gt;
                </button>
                <button type="button" onclick={() => insertMarkdown('quote', 'quote')} class="p-1 hover:bg-gray-200 rounded" title="Quote">
                  "
                </button>
                <button type="button" onclick={() => insertMarkdown('list', 'list item')} class="p-1 hover:bg-gray-200 rounded" title="List">
                  •
                </button>
              </div>
              ...
              <textarea
                ...
                rows="15"
                disabled={loading || !isAuthenticated}
                class="w-full px-4 py-3 border border-gray-300 rounded-b-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500 font-mono text-sm"
                style="border-top: none;"
                required
              ></textarea>
            {:else}
              <!-- Preview -->
              <div class="border border-gray-300 rounded-md p-4 bg-white min-h-96">
                <div class="prose max-w-none">
                  <h1>{title || 'Your Title Here'}</h1>
                  {#if excerpt}
                    <p class="lead text-gray-600">{excerpt}</p>
                  {/if}
                  <div class="whitespace-pre-wrap">{content || 'Your content will appear here...'}</div>
                </div>
              </div>
            {/if}
          </div>
    ...
    <div class="lg:col-span-1">
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <h3 class="text-sm font-medium text-gray-900 mb-4">Post Settings</h3>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                bind:value={category}
                disabled={loading || !isAuthenticated}
                class="w-full text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50"
              >
            ...
            <div>
              ...
              <input
                ...
                disabled={loading || !isAuthenticated}
                class="w-full text-sm px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50"
              />
            </div>

            <!-- Featured Image -->
            <div>
              <label for="featuredImage" class="block text-xs font-medium text-gray-700 mb-1">
                Featured Image URL
              </label>
              <input
                type="url"
            ...
            <!-- Publish Date -->
            <div>
              <label for="publishDate" class="block text-xs font-medium text-gray-700 mb-1">
                Publish Date
              </label>
              <input
                type="datetime-local"
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <button
            ...
            class="flex items-center justify-between w-full text-sm font-medium text-gray-900 mb-4"
          >
            SEO Settings
            <svg class="w-4 h-4 transform transition-transform" class:rotate-180={showAdvanced} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {#if showAdvanced}
            <div class="space-y-4">
              <!-- SEO Title -->
              <div>
                <label for="seoTitle" class="block text-xs font-medium text-gray-700 mb-1">
                  SEO Title
              ...
              <!-- SEO Description -->
              <div>
                <label for="seoDescription" class="block text-xs font-medium text-gray-700 mb-1">
                  SEO Description
        ...
        <!-- Post Stats -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <h3 class="text-sm font-medium text-gray-900 mb-3">Writing Stats</h3>
