...
<div class="max-w-6xl mx-auto">
  <div class="mb-8">
    ...
    <p class="mt-2 text-lg text-gray-600">
      Welcome to the Svelte Components demonstration project. This dashboard shows the integration between the sample app and the new API server.
    </p>
  </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
    <!-- API Features -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h2 class="text-xl font-semibold text-gray-900 mb-4">API Features</h2>
      <div class="space-y-4">
        <div class="flex items-start">
          ...
          <div class="ml-3">
            ...
            <p class="text-sm text-gray-500">Persistent storage with posts, configuration, and activity logs</p>
          </div>
        </div>
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3">
            ...
            <p class="text-sm text-gray-500">Full CRUD operations for posts and configuration management</p>
          </div>
        </div>
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3">
            ...
            <p class="text-sm text-gray-500">Rate limiting, CORS, health checks, and activity logging</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Frontend Features -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h2 class="text-xl font-semibold text-gray-900 mb-4">Frontend Features</h2>
      <div class="space-y-4">
        <div class="flex items-start">
          <div class="flex-shrink-0">
          ...
          <div class="ml-3">
            ...
            <p class="text-sm text-gray-500">Create, edit, view, and delete blog posts with draft/publish states</p>
          </div>
        </div>
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3">
            ...
            <p class="text-sm text-gray-500">Live configuration updates and memory logger integration</p>
          </div>
        </div>
  ...
  {#if apiHealth}
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
      <h2 class="text-xl font-semibold text-gray-900 mb-4">API Server Status</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          <h3 class="text-sm font-medium text-gray-500 mb-2">Server Info</h3>
        ...
        <div>
          ...
          <div class="space-y-1 text-sm">
            <p><span class="font-medium">Status:</span> 
              <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {apiHealth.database.status === 'connected' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}">
                {apiHealth.database.status}
              </span>
            </p>
            {#if apiHealth.database.responseTime}
              <p><span class="font-medium">Response Time:</span> {apiHealth.database.responseTime}ms</p>
            {/if}
          </div>
        </div>

        <div>
          <h3 class="text-sm font-medium text-gray-500 mb-2">Endpoints</h3>
          <div class="space-y-1 text-sm">
            <p><a href="http://localhost:3001/api/health" target="_blank" class="text-blue-600 hover:text-blue-800">Health Check</a></p>
            <p><a href="http://localhost:3001/api/config/public" target="_blank" class="text-blue-600 hover:text-blue-800">Public Config</a></p>
            <p><a href="http://localhost:3001/api/posts/public" target="_blank" class="text-blue-600 hover:text-blue-800">Public Posts</a></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      {#if isAuthenticated}
        <a href="/posts/create" 
           class="flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          ✍️ Create Post
        </a>
      {/if}
      <a href="/api-demo" 
