<#
.SYNOPSIS
Builds the authentication library and installs it in the sample application.

.DESCRIPTION
This script builds the Svelte.Auth library, packages it, and installs it
...
$libDir = Join-Path $root 'Svelte.Auth'
